# 🚀 增强版YOLOv11-OBB模型 - 多尺度特征融合与注意力机制改进
...
# 使用增强版模型
model = YOLO('ultralytics/cfg/models/11/yolo11-obb-enhanced.yaml')

# 开始训练
results = model.train(
    data='data_processing/DOTAv2.yaml',
    epochs=100,
    imgsz=1024,
    batch=16,
    device='cuda'  # 建议使用GPU
