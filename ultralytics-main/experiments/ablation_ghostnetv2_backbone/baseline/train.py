...
def main() -> None:
    ...
    # 9. 打印使用的关键配置（用于确认）
    print("\n" + "="*60)
    print("📋 YOLO_DDBC Baseline 训练配置摘要")
    print("="*60)
    print("🔧 模型组件:")
    print("  - C3k2_DCA: 基于 DCNv4 和坐标注意力的特征提取模块（骨干）")
    print("  - DDPG: 膨胀深度可分离金字塔门控融合模块（Neck）")
    print("  - BiFPN_DWC: 动态权重修正双向特征金字塔网络（Neck）")
    print("  - CSL_ProbIoU: 基于 CSL 角度编码和 ProbIoU 的损失函数")
    print("="*60)
