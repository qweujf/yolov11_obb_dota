...
if mmcv_ok and mmengine_ok and mmdet_ok and mmrotate_ok:
    ...
    if "mmrotate" in missing_packages and "DLL load failed" in import_errors.get("mmrotate", ""):
        ...
        print("\n解决方案（按顺序尝试）：")
        print("\n方案1：检查并重新安装兼容版本组合（推荐）")
        print("   # 查看当前版本")
        print("   pip show mmcv-lite mmrotate mmdet mmengine")
        print("   # mmrotate 0.3.4 需要 mmcv >= 2.0.0")
        print("   # 如果版本不匹配，尝试：")
        print("   pip uninstall mmcv-lite mmrotate -y")
        print("   pip install mmcv-lite==2.0.1")
